-- Admin approve flow: admin_set_account_status must transition seller to approved+verified seller
-- so that AdminSellers dashboard moves users out of "Pending Sellers" into "Approved".
